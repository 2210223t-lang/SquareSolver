g++ main.cpp CorrectIO.cpp EquationTools.cpp SquareEquationSolver.cpp \
    -D _DEBUG -ggdb3 -std=c++17 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-align -Wcast-qual \
